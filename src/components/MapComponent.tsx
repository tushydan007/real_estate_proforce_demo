...
const MapLogic = ({
  ...
  const activeLayerRef = useRef<L.TileLayer | null>(null); // Track the active base map layer
  ...
  useEffect(() => {
    ...
    const dark = L.tileLayer(
      ...
      {
        attribution:
          "&copy; <a href='https://www.openstreetmap.org/copyright'>OpenStreetMap</a> contributors, Tiles © Esri &mdash; Source: Esri, DeLorme, NAVTEQ",
        maxZoom: 20,
      }
    );
    ...
    // Load saved basemap or default to OpenStreetMap
    const savedBasemap = localStorage.getItem("basemap") || "OpenStreetMap";
    activeLayerRef.current = baseMaps[savedBasemap] || osm;
