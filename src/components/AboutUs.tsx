...
//       <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
//         <div
//           className="absolute inset-0 bg-[url('./assets/space-bg.jpg')] bg-cover bg-center bg-fixed opacity-40 transition-opacity duration-1000"
//           style={{ backgroundAttachment: "fixed" }}
//         />
//         <div className="absolute inset-0 bg-gradient-to-b from-black/90 to-black/75" />
...
//       {/* Our Story */}
//       <section className="w-full py-24 px-4 md:px-8 lg:px-16 bg-black border-b border-gray-700">
//         <div className="max-w-5xl mx-auto text-center">
